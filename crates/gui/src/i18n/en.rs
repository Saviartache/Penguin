...
pub static STRINGS: Strings = Strings {
    ...
    choose_protocol_hint: "How to connect. The form for that protocol opens next.",
    hysteria2_summary: "Fast tunnel over QUIC. Looks like HTTP/3, holds the speed you set.",
    socks5_summary: "Plain proxy. No encryption — for your own network and machines.",
    http_summary: "CONNECT proxy. Address and password travel in the clear.",
    https_summary: "CONNECT proxy inside TLS. The same, but the talk with the proxy is encrypted.",
