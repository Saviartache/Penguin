...
#[cfg(unix)]
mod command;
// Окно выбора файла: им человек показывает программу, которой нет среди
// запущенных. Своего окна у клиента нет, а системное умеет то, чего своё не
// умело бы никогда, — от сетевых дисков до прав на чужие каталоги.
pub mod dialog;
